...
static CK_RV test_derive_tls12_key_and_mac(void *args) {
    ...
    static unsigned char expected_client_mac_key[] = {
        0x87, 0xb0, 0xe8, 0x26, 0x1c, 0x3c, 0x8a, 0x54,
        0x41, 0xe9, 0xaf, 0xbe, 0x25, 0xfd, 0xdc, 0x4d,
        0x5e, 0x8f, 0xb8, 0xb8, 0x7b, 0x67, 0x78, 0x8e,
        0xc5, 0xa2, 0x50, 0x20, 0xe5, 0xb8, 0x7c, 0x75
    };

    static unsigned char expected_server_mac_key[] = {
        0xda, 0x5e, 0xfe, 0x29, 0x01, 0xab, 0x65, 0xc2,
        0xf3, 0x92, 0xdc, 0xe7, 0x43, 0x2e, 0x44, 0x4f,
        0x43, 0x3a, 0x80, 0xf8, 0xe8, 0xbc, 0x18, 0xad,
        0xd4, 0x97, 0x51, 0xa6, 0x94, 0xfe, 0xf2, 0x71
    };

    static unsigned char expected_client_key[] = {
        0x73, 0x23, 0x8e, 0xbe, 0x25, 0x53, 0x50, 0xb3,
        0xe7, 0x95, 0x18, 0xbb, 0x46, 0xed, 0x8d, 0x9f
    };

    static unsigned char expected_server_key[] = {
        0x06, 0x23, 0x74, 0x44, 0xd8, 0xb2, 0xf3, 0x40,
        0x3a, 0x79, 0x0b, 0x5e, 0xa2, 0x87, 0xe3, 0xaf
    };

    static unsigned char expected_client_iv[] = {
        0x0a, 0xc1, 0xae, 0x94, 0xfd, 0xa8, 0x42, 0xaf,
        0x0d, 0x86, 0xf5, 0xcb, 0x4b, 0x87, 0xb4, 0x5d
    };

    static unsigned char expected_server_iv[] = {
        0x2a, 0x5f, 0xcc, 0x6a, 0x25, 0xdf, 0x4b, 0xd1,
        0x2d, 0x23, 0x9d, 0x9c, 0xac, 0x29, 0x02, 0x42
    };
    ...
    if (ret == CKR_OK) {
        ret = funcList->C_DeriveKey(session, &mechanism, premasterSecret,
                                    derivedKeyTemplate,
                                    ulDerivedKeyTemplateCount, NULL);
        CHECK_CKR(ret, "Derive key");
    }
