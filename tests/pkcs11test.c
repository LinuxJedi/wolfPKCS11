...
static CK_RV test_tpm_memory(void* args)
{
    CK_RV ret = CKR_OK;
    int sessFlags = CKF_SERIAL_SESSION | CKF_RW_SESSION;
    CK_SESSION_HANDLE session = *(CK_SESSION_HANDLE*)args;
    ...
    CK_BYTE abyTemplate0[] = { 0x1 };

    CK_BYTE abyTemplate1[] = { 0x6F, 0xE8, 0x81, 0xF9, 0x1B, 0xD1, 0x99, 0x80, 0x55, 0x73, 0x40, 0x88, 0x73, 0x22, 0x5F, 0x77, 0x4C, 0xCA, 0x8C, 0x94 };

    CK_BYTE abyTemplate2[] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };

    CK_BYTE abyTemplate3[] = { 0x43, 0xDD, 0x4, 0x3C, 0x79, 0x7B, 0xDA, 0x86, 0xF6, 0xBF, 0xEE, 0xAB, 0x5B, 0xBF, 0x2E, 0x15, 0x72, 0x43, 0xE6, 0x44, 0x36, 0x1F, 0x7E, 0xAD, 0xEF, 0x75, 0x11, 0xA4, 0xE0, 0x50, 0xBF, 0x7B, 0x67, 0xD3, 0x67, 0xD5, 0x7D, 0xEE, 0xAC, 0x89, 0xD1, 0x3, 0xC8, 0x65, 0xE0, 0xB3, 0xF1, 0x46, 0x38, 0x80, 0xEE, 0x45, 0x4D, 0xA5, 0xE2, 0x8A, 0xC3, 0x9F, 0xDE, 0xF9, 0x7C, 0xC0, 0xFA, 0x60, 0xD7, 0x7F, 0x86, 0xCB, 0x48, 0x76, 0x24, 0x85, 0xF4, 0x97, 0xBF, 0x85, 0x5D, 0x38, 0x81, 0x1C, 0xE3, 0xF8, 0x68, 0x32, 0x79, 0x2D, 0xF4, 0x31, 0x66, 0xE4, 0xBB, 0x67, 0xEF, 0x3F, 0xA9, 0x99, 0x57, 0xFB, 0xA1, 0x6B, 0x0, 0x94, 0xFB, 0x83, 0x2B, 0xC2, 0x9, 0x82, 0x49, 0x1E, 0xF9, 0x81, 0x60, 0xC6, 0x77, 0xAD, 0xD5, 0x17, 0x55, 0x1, 0xFE, 0x89, 0x7C, 0x82, 0x5F, 0x40, 0xC8, 0xF5 };

    CK_BYTE abyTemplate4[] = { 0x0, 0xDD, 0x83, 0x1F, 0x44, 0x8, 0x33, 0x23, 0x2A, 0x26, 0xB8, 0xAB, 0xFA, 0xE1, 0xC9, 0x1E, 0xE6, 0xF6, 0x51, 0xD1, 0x95, 0xBA, 0x96, 0xD2, 0x9A, 0xB1, 0x7, 0x32, 0x7B, 0xCC, 0xE6, 0x69, 0xA2, 0x4F, 0x6B, 0x6, 0xAE, 0x3C, 0x27, 0x49, 0x3C, 0x56, 0x52, 0x24, 0xCB, 0xC2, 0xA8, 0x7F, 0x6B, 0x72, 0x58, 0x6B, 0x4B, 0xD2, 0xD7, 0xEC, 0x5E, 0xCD, 0x1D, 0x3F, 0xBB, 0xE8, 0xF6, 0x97, 0xB6, 0xEA, 0xCE, 0x5E, 0xDF, 0x59, 0x43, 0xA2, 0x6C, 0x7A, 0x12, 0xF6, 0xDF, 0x66, 0xD3, 0x8C, 0xF9, 0x75, 0xBB, 0xDD, 0x70, 0x67, 0x38, 0x5C, 0x4A, 0x58, 0x7E, 0x53, 0xB, 0x61, 0x61, 0xB8, 0xBD, 0xD, 0xAB, 0x7B, 0x4D, 0xB4, 0x70, 0xD5, 0x83, 0x64, 0xFF, 0x46, 0x54, 0xD8, 0x90, 0xBA, 0xD7, 0xD1, 0x8C, 0x41, 0x3E, 0x84, 0xE5, 0x3A, 0x9F, 0xCA, 0x14, 0xBB, 0x2B, 0xE3, 0x28, 0x31, 0x73 };

3E, 0x62, 0x31, 0x72, 0x21, 0xFC, 0xED, 0x2F, 0xBB, 0x2D, 0x76, 0xFA, 0xFA, 0x18, 0x91, 0x6D, 0x3E, 0xD6, 0x12, 0xF3, 0xBD, 0x4B, 0x2D, 0x2B, 0x41, 0x2E, 0x42, 0x8D, 0x6D, 0x89, 0xF5, 0xF7, 0xB6, 0x72, 0xF, 0x0, 0x9E, 0xDB, 0xDE, 0x5C, 0xF3, 0x80, 0xC5, 0xD8, 0x11, 0x18, 0x41, 0xBE, 0x7F, 0xC2, 0x3B, 0x8E, 0xF1, 0x43, 0x9B, 0x4F, 0xD4, 0xE7, 0x53, 0x7A, 0x4D, 0x90, 0x4F, 0xEF, 0x6B, 0x9A, 0x89, 0x4C, 0xC0, 0x26, 0x62, 0x42, 0x85, 0x2, 0x1B, 0x16, 0x7F, 0xEB, 0x66, 0xA7, 0x3E, 0xC1, 0x55, 0x8, 0x97 };

    CK_BYTE abyTemplate11[] = { 0x0 };

    CK_BYTE abyTemplate12[] = { 0x0 };

    CK_BYTE abyTemplate13[] = { 0x1 };

    CK_BYTE abyTemplate14[] = { 0x63, 0x6E, 0x3D, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x31, 0x2C, 0x20, 0x6F, 0x75, 0x3D, 0x54, 0x4F, 0x4B, 0x45, 0x4E, 0x2C, 0x20, 0x6F, 0x3D, 0x43, 0x4C, 0x41, 0x41, 0x53, 0x20, 0x47, 0x72, 0x6F, 0x75, 0x70, 0x2C, 0x20, 0x63, 0x3D, 0x44, 0x45 };

    CK_BYTE abyTemplate15[] = { 0x0 };

    CK_BYTE abyTemplate16[] = { 0x1 };

    CK_BYTE abyTemplate17[] = { 0x1 };

    CK_BYTE abyTemplate18[] = { 0x1 };

    CK_BYTE abyTemplate19[] = { 0x3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };



    CK_ATTRIBUTE aTemplateAttributes[]

        = { { 0x103, abyTemplate0, 1},      // CKA_SENSITIVE

            { 0x102, abyTemplate1, 20},     // CKA_ID

            { 0x100, abyTemplate2, 8},      // CKA_KEY_TYPE

            { 0x128, abyTemplate3, 128},    // CKA_COEFFICIENT

            { 0x127, abyTemplate4, 129},    // CKA_EXPONENT_2

            { 0x126, abyTemplate5, 128},    // CKA_EXPONENT_1

            { 0x125, abyTemplate6, 129},    // CKA_PRIME_2

            { 0x124, abyTemplate7, 129},    // CKA_PRIME_1

            { 0x123, abyTemplate8, 256},    // CKA_PRIVATE_EXPONENT

            { 0x162, abyTemplate9, 1},      // CKA_EXTRACTABLE

            { 0x120, abyTemplate10, 257},   // CKA_MODULUS

            { 0x10C, abyTemplate11, 1},     // CKA_DERIVE

            { 0x109, abyTemplate12, 1},     // CKA_SIGN_RECOVER

            { 0x108, abyTemplate13, 1},     // CKA_SIGN

            { 0x3, abyTemplate14, 50},      // CKA_LABEL

            { 0x107, abyTemplate15, 1},     // CKA_UNWRAP

            { 0x2, abyTemplate16, 1},       // CKA_PRIVATE

            { 0x1, abyTemplate17, 1},       // CKA_TOKEN

            { 0x105, abyTemplate18, 1},     // CKA_DECRYPT

            { 0x0, abyTemplate19, 8}        // CKA_CLASS
...
static TEST_FUNC testFunc[] = {
    ...
    PKCS11TEST_FUNC_SESS_DECL(test_tpm_memory)
};
