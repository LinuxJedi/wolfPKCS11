...
static CK_RV test_user(void* args)
{
    CK_SESSION_HANDLE session = *(CK_SESSION_HANDLE*)args;
    CK_RV ret;

    // Search for an Object
    CK_BYTE abySearchTemplate0[] = { 0x0, 0x0, 0x0, 0x0 };

    CK_BYTE abySearchTemplate1[] = { 0xDE, 0x3B, 0xA5, 0x18, 0x5B, 0x5F, 0x59, 0x96, 0x82, 0x41, 0x82, 0xD4, 0xD, 0xB0, 0x80, 0x38, 0xDE, 0x4F, 0x65, 0x69, 0x2D, 0x32, 0xD9, 0x24, 0xCA, 0xD3, 0xF6, 0x1F, 0x32, 0xD9, 0xF, 0xA9, 0xD6, 0xB0, 0xF6, 0x3, 0x11, 0x9, 0x38, 0xE2, 0x3, 0xAE, 0xF1, 0xDE, 0xAE, 0x4C, 0x3E, 0xC8, 0x9C, 0xB9, 0x9F, 0xBD, 0x60, 0xA3, 0xD1, 0xEC, 0x48, 0xEA, 0xB0, 0xDF, 0x5B, 0xD1, 0x0, 0x57, 0xD2, 0x4, 0xD4, 0x1D, 0xA4, 0xC, 0x68, 0x7A, 0x99, 0x2D, 0xC6, 0xC5, 0x29, 0xEC, 0xF7, 0x9B, 0xBC, 0x7, 0x29, 0xFF, 0x2C, 0xD0, 0x77, 0xB, 0x6C, 0x97, 0xFF, 0x29, 0xEF, 0x47, 0xBB, 0xE, 0x30, 0x52, 0x85, 0x52, 0x36, 0xE, 0x44, 0xBE, 0x1E, 0x78, 0xF0, 0xB7, 0x67, 0xE2, 0xC2, 0x86, 0xFD, 0x20, 0xC0, 0x67, 0x3, 0xFC, 0xF8, 0x8B, 0xD3, 0x67, 0x34, 0xD2, 0xA6, 0xA0, 0x5A, 0x9C, 0x68, 0x9, 0xCD, 0x2B, 0xA9, 0x70, 0x22, 0x7D, 0x82, 0xB8, 0x25, 0x6B, 0xC8, 0xB3, 0x2, 0x7C, 0x6E, 0xBC, 0x5A, 0xA7, 0x26, 0x89, 0x1F, 0x8F, 0x75, 0x2C, 0x15, 0x43, 0x5C, 0xBD, 0xAB, 0xA4, 0x75, 0x90, 0x72, 0xDD, 0x92, 0x3, 0xF8, 0x6, 0x38, 0x74, 0x94, 0x21, 0x69, 0x29, 0x37, 0x44, 0x4A, 0x76, 0xF1, 0x6B, 0xF1, 0xA8, 0x53, 0xD, 0x7A, 0x33, 0x2F, 0x64, 0x12, 0x79, 0x35, 0xC9, 0x96, 0x4C, 0xD2, 0xA1, 0x2C, 0x50, 0xC9, 0xCE, 0xB1, 0xE1, 0x6C, 0x42, 0xB1, 0xC5, 0xFA, 0xED, 0x89, 0xDB, 0xA2, 0x67, 0x8F, 0x1A, 0x26, 0x95, 0xBB, 0x80, 0xA9, 0xD2, 0x66, 0x3F, 0x6, 0xD1, 0x74, 0x94, 0x81, 0x3E, 0x4D, 0xBF, 0x15, 0x1B, 0x69, 0x9A, 0x5D, 0xFD, 0x6F, 0xFB, 0xF2, 0xE6, 0x89, 0x9A, 0x5B, 0x7D, 0x7E, 0xE0, 0x4A, 0xD2, 0x80, 0x87, 0x88, 0x0, 0x9, 0x92, 0x56, 0xF5 };

    CK_BYTE abySearchTemplate2[] = { 0x3, 0x0, 0x0, 0x0 };


    CK_ATTRIBUTE aSearchAttributes[] = { { 0x100, abySearchTemplate0, sizeof(abySearchTemplate0) },

                                            { 0x120, abySearchTemplate1, sizeof(abySearchTemplate1) },

                                            { 0x0, abySearchTemplate2, sizeof(abySearchTemplate2) }

                                        };


    ret = funcList->C_FindObjectsInit(session, aSearchAttributes, sizeof(aSearchAttributes) / sizeof(CK_ATTRIBUTE));
    CHECK_CKR(ret, "Find objects init");
    ...
    if (ret == CKR_OK) {
        while (bKeyFound == 0) {
            ...
            // Check if Object behind hObjectFound is the one sought after
            ...
            ret = funcList->C_GetAttributeValue(session, hObjectFound, aAttributes, uiNumberOfAttributes);
            ...
            {
                void* pBuffer = malloc(aAttributes[i].ulValueLen);
                aAttributes[i].pValue = pBuffer;
            }

            ret = funcList->C_GetAttributeValue(session, hObjectFound, aAttributes, uiNumberOfAttributes);

            CHECK_CKR(ret, "Get Attribute Value 2");
    ...
    CK_BYTE abyTemplate0[] = { 0x30, 0x82, 0x3, 0x8F, 0x30, 0x82, 0x2, 0x77, 0xA0, 0x3, 0x2, 0x1, 0x2, 0x2, 0x1, 0x1, 0x30, 0xD, 0x6, 0x9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0xD, 0x1, 0x1, 0xB, 0x5, 0x0, 0x30, 0x62, 0x31, 0xB, 0x30, 0x9, 0x6, 0x3, 0x55, 0x4, 0x6, 0x13, 0x2, 0x44, 0x45, 0x31, 0xF, 0x30, 0xD, 0x6, 0x3, 0x55, 0x4, 0x8, 0xC, 0x6, 0x48, 0x65, 0x73, 0x73, 0x65, 0x6E, 0x31, 0x12, 0x30, 0x10, 0x6, 0x3, 0x55, 0x4, 0x7, 0xC, 0x9, 0x46, 0x72, 0x61, 0x6E, 0x6B, 0x66, 0x75, 0x72, 0x74, 0x31, 0x10, 0x30, 0xE, 0x6, 0x3, 0x55, 0x4, 0xA, 0xC, 0x7, 0x73, 0x65, 0x63, 0x75, 0x6E, 0x65, 0x74, 0x31, 0x1C, 0x30, 0x1A, 0x6, 0x3, 0x55, 0x4, 0x3, 0xC, 0x13, 0x73, 0x65, 0x63, 0x75, 0x6E, 0x65, 0x74, 0x5F, 0x70, 0x72, 0x6F, 0x6A, 0x65, 0x63, 0x74, 0x5F, 0x78, 0x79, 0x7A, 0x30, 0x1E, 0x17, 0xD, 0x31, 0x37, 0x30, 0x39, 0x31, 0x39, 0x31, 0x34, 0x32, 0x30, 0x32, 0x36, 0x5A, 0x17, 0xD, 0x31, 0x37, 0x31, 0x30, 0x31, 0x37, 0x31, 0x34, 0x32, 0x30, 0x32, 0x36, 0x5A, 0x30, 0x62, 0x31, 0xB, 0x30, 0x9, 0x6, 0x3, 0x55, 0x4, 0x6, 0x13, 0x2, 0x44, 0x45, 0x31, 0xF, 0x30, 0xD, 0x6, 0x3, 0x55, 0x4, 0x8, 0xC, 0x6, 0x48, 0x65, 0x73, 0x73, 0x65, 0x6E, 0x31, 0x12, 0x30, 0x10, 0x6, 0x3, 0x55, 0x4, 0x7, 0xC, 0x9, 0x46, 0x72, 0x61, 0x6E, 0x6B, 0x66, 0x75, 
0xB4, 0x49, 0x9, 0xA1, 0x3F, 0xCE, 0x98, 0x5E, 0xC1, 0xA6, 0x3E, 0xC1, 0xB4, 0xB7, 0xB6, 0x97, 0x1, 0xA0, 0xCC, 0x57, 0xDF, 0xFA, 0xB, 0x93, 0xFE, 0xDD, 0x5F, 0xFF, 0x2B, 0x60, 0x83, 0x65, 0xB4, 0x32, 0x8C, 0xB2, 0x86, 0xC7, 0xED, 0x20, 0x9C, 0x84, 0x54, 0x98, 0xFA, 0xCC, 0xC3, 0xBC, 0x88, 0xDC, 0xB3, 0x50, 0xFD, 0x6D, 0xB5, 0xCA, 0x9B, 0xC, 0xE4, 0xA5, 0xAB, 0x46, 0x36, 0x29, 0xB1, 0x99, 0x95, 0x70, 0x95, 0xB5, 0xC4, 0x1D, 0xFF, 0x22, 0xF0, 0xA0, 0x93, 0x5A, 0x2, 0x96, 0xA8, 0x2, 0x9B, 0xE1, 0x46, 0x80, 0xAA, 0x9D, 0x13, 0xBE, 0x42, 0x22, 0xCA, 0x34, 0x1, 0x97, 0x73, 0xC7, 0x3C, 0xC1, 0x96, 0x63, 0xF1, 0xBC, 0xF1, 0xA4, 0xD0, 0xFF, 0xAF, 0x1D, 0xBE, 0x17, 0x51, 0x66, 0xFA, 0xAE, 0x5, 0x7F, 0xC4, 0x56, 0x1F, 0x9F, 0xD3 };

    CK_BYTE abyTemplate1[] = { 0x1 };

    CK_BYTE abyTemplate2[] = { 0x73, 0x65, 0x63, 0x75, 0x6E, 0x65, 0x74, 0x5F, 0x70, 0x72, 0x6F, 0x6A, 0x65, 0x63, 0x74, 0x5F, 0x78, 0x79, 0x7A, 0x27, 0x73, 0x20, 0x73, 0x65, 0x63, 0x75, 0x6E, 0x65, 0x74, 0x5F, 0x70, 0x72, 0x6F, 0x6A, 0x65, 0x63, 0x74, 0x5F, 0x78, 0x79, 0x7A, 0x20, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65 };

    CK_BYTE abyTemplate3[] = { 0x2, 0x1, 0x1 };

    CK_BYTE abyTemplate4[] = { 0xD8, 0x3E, 0xD5, 0x55, 0x13, 0x61, 0xA1, 0xF0, 0x12, 0xCA, 0x7E, 0x51, 0x37, 0xEF, 0xA6, 0x43, 0x44, 0xB7, 0xA8, 0xF };

    CK_BYTE abyTemplate5[] = { 0x0 };

    CK_BYTE abyTemplate6[] = { 0x30, 0x62, 0x31, 0xB, 0x30, 0x9, 0x6, 0x3, 0x55, 0x4, 0x6, 0x13, 0x2, 0x44, 0x45, 0x31, 0xF, 0x30, 0xD, 0x6, 0x3, 0x55, 0x4, 0x8, 0xC, 0x6, 0x48, 0x65, 0x73, 0x73, 0x65, 0x6E, 0x31, 0x12, 0x30, 0x10, 0x6, 0x3, 0x55, 0x4, 0x7, 0xC, 0x9, 0x46, 0x72, 0x61, 0x6E, 0x6B, 0x66, 0x75, 0x72, 0x74, 0x31, 0x10, 0x30, 0xE, 0x6, 0x3, 0x55, 0x4, 0xA, 0xC, 0x7, 0x73, 0x65, 0x63, 0x75, 0x6E, 0x65, 0x74, 0x31, 0x1C, 0x30, 0x1A, 0x6, 0x3, 0x55, 0x4, 0x3, 0xC, 0x13, 0x73, 0x65, 0x63, 0x75, 0x6E, 0x65, 0x74, 0x5F, 0x70, 0x72, 0x6F, 0x6A, 0x65, 0x63, 0x74, 0x5F, 0x78, 0x79, 0x7A };

    CK_BYTE abyTemplate7[] = { 0x30, 0x62, 0x31, 0xB, 0x30, 0x9, 0x6, 0x3, 0x55, 0x4, 0x6, 0x13, 0x2, 0x44, 0x45, 0x31, 0xF, 0x30, 0xD, 0x6, 0x3, 0x55, 0x4, 0x8, 0xC, 0x6, 0x48, 0x65, 0x73, 0x73, 0x65, 0x6E, 0x31, 0x12, 0x30, 0x10, 0x6, 0x3, 0x55, 0x4, 0x7, 0xC, 0x9, 0x46, 0x72, 0x61, 0x6E, 0x6B, 0x66, 0x75, 0x72, 0x74, 0x31, 0x10, 0x30, 0xE, 0x6, 0x3, 0x55, 0x4, 0xA, 0xC, 0x7, 0x73, 0x65, 0x63, 0x75, 0x6E, 0x65, 0x74, 0x31, 0x1C, 0x30, 0x1A, 0x6, 0x3, 0x55, 0x4, 0x3, 0xC, 0x13, 0x73, 0x65, 0x63, 0x75, 0x6E, 0x65, 0x74, 0x5F, 0x70, 0x72, 0x6F, 0x6A, 0x65, 0x63, 0x74, 0x5F, 0x78, 0x79, 0x7A };

    CK_BYTE abyTemplate8[] = { 0x1 };

    CK_ULONG abyTemplate9 = CKC_X_509;

    CK_ULONG abyTemplate10 = CKO_CERTIFICATE;


    CK_ATTRIBUTE aTemplateAttributes[]
        = { { 0x11, abyTemplate0, 915 },    // CKA_VALUE
            { 0x86, abyTemplate1, 1 },      // CKA_TRUSTED
            { 0x3, abyTemplate2, 53 },      // CKA_LABEL
            { 0x82, abyTemplate3, 3 },      // CKA_SERIAL_NUMBER
            { 0x102, abyTemplate4, 20 },    // CKA_ID
            { 0x2, abyTemplate5, 1 },       // CKA_PRIVATE
            { 0x81, abyTemplate6, 100 },    // CKA_ISSUER
            { 0x101, abyTemplate7, 100 },   // CKA_SUBJECT
            { 0x1, abyTemplate8, 1 },       // CKA_TOKEN
            { 0x80, &abyTemplate9, sizeof(abyTemplate9) },      // CKA_CERTIFICATE_TYPE
            { 0x0, &abyTemplate10, sizeof(abyTemplate10) },      // CKA_CLASS
            };
    ...
    // Search for an Object
    CK_BYTE bySearchTemplate0[] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };
    CK_BYTE bySearchTemplate1[] = { 0xDE, 0x3B, 0xA5, 0x18, 0x5B, 0x5F, 0x59, 0x96, 0x82, 0x41, 0x82, 0xD4, 0xD, 0xB0, 0x80, 0x38, 0xDE, 0x4F, 0x65, 0x69, 0x2D, 0x32, 0xD9, 0x24, 0xCA, 0xD3, 0xF6, 0x1F, 0x32, 0xD9, 0xF, 0xA9, 0xD6, 0xB0, 0xF6, 0x3, 0x11, 0x9, 0x38, 0xE2, 0x3, 0xAE, 0xF1, 0xDE, 0xAE, 0x4C, 0x3E, 0xC8, 0x9C, 0xB9, 0x9F, 0xBD, 0x60, 0xA3, 0xD1, 0xEC, 0x48, 0xEA, 0xB0, 0xDF, 0x5B, 0xD1, 0x0, 0x57, 0xD2, 0x4, 0xD4, 0x1D, 0xA4, 0xC, 0x68, 0x7A, 0x99, 0x2D, 0xC6, 0xC5, 0x29, 0xEC, 0xF7, 0x9B, 0xBC, 0x7, 0x29, 0xFF, 0x2C, 0xD0, 0x77, 0xB, 0x6C, 0x97, 0xFF, 0x29, 0xEF, 0x47, 0xBB, 0xE, 0x30, 0x52, 0x85, 0x52, 0x36, 0xE, 0x44, 0xBE, 0x1E, 0x78, 0xF0, 0xB7, 0x67, 0xE2, 0xC2, 0x86, 0xFD, 0x20, 0xC0, 0x67, 0x3, 0xFC, 0xF8, 0x8B, 0xD3, 0x67, 0x34, 0xD2, 0xA6, 0xA0, 0x5A, 0x9C, 0x68, 0x9, 0xCD, 0x2B, 0xA9, 0x70, 0x22, 0x7D, 0x82, 0xB8, 0x25, 0x6B, 0xC8, 0xB3, 0x2, 0x7C, 0x6E, 0xBC, 0x5A, 0xA7, 0x26, 0x89, 0x1F, 0x8F, 0x75, 0x2C, 0x15, 0x43, 0x5C, 0xBD, 0xAB, 0xA4, 0x75, 0x90, 0x72, 0xDD, 0x92, 0x3, 0xF8, 0x6, 0x38, 0x74, 0x94, 0x21, 0x69, 0x29, 0x37, 0x44, 0x4A, 0x76, 0xF1, 0x6B, 0xF1, 0xA8, 0x53, 0xD, 0x7A, 0x33, 0x2F, 0x64, 0x12, 0x79, 0x35, 0xC9, 0x96, 0x4C, 0xD2, 0xA1, 0x2C, 0x50, 0xC9, 0xCE, 0xB1, 0xE1, 0x6C, 0x42, 0xB1, 0xC5, 0xFA, 0xED, 0x89, 0xDB, 0xA2, 0x67, 0x8F, 0x1A, 0x26, 0x95, 0xBB, 0x80, 0xA9, 0xD2, 0x66, 0x3F, 0x6, 0xD1, 0x74, 0x94, 0x81, 0x3E, 0x4D, 0xBF, 0x15, 0x1B, 0x69, 0x9A, 0x5D, 0xFD, 0x6F, 0xFB, 0xF2, 0xE6, 0x89, 0x9A, 0x5B, 0x7D, 0x7E, 0xE0, 0x4A, 0xD2, 0x80, 0x87, 0x88, 0x0, 0x9, 0x92, 0x56, 0xF5 };
    CK_BYTE bySearchTemplate2[] = { 0x3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };
    CK_ATTRIBUTE bSearchAttributes[] = { { 0x100, bySearchTemplate0, sizeof(abySearchTemplate0) },
    { 0x120, bySearchTemplate1, sizeof(bySearchTemplate1) },
    { 0x0, bySearchTemplate2, sizeof(bySearchTemplate2) }
    };

    if (ret == CKR_OK) {
        ret = funcList->C_FindObjectsInit(session, bSearchAttributes, sizeof(bSearchAttributes) / sizeof(CK_ATTRIBUTE));
        CHECK_CKR(ret, "Find objects init");
    }
    ...
    if (ret == CKR_OK) {
        while (bKeyFound == 0) {
            ret = funcList->C_FindObjects(session, &hObjectFound, 1, &ulObjectCount); // <- CRASH!!!
            CHECK_CKR(ret, "Find objects");
            ...
            CHECK_CKR(ret, "Failed to get attribute values");
            if (ret != CKR_OK)
                break;
            ...
            CHECK_CKR(ret, "Get attribute values failed");
            if (ret != CKR_OK)
                break;
    ...
    if (ret == CKR_OK) {
        ret = funcList->C_FindObjectsFinal(session);
        CHECK_CKR(ret, "Find objects final failed");
    }
...
static TEST_FUNC testFunc[] = {
    ...
    PKCS11TEST_FUNC_SESS_DECL(test_user),
